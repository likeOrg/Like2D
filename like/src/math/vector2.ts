...
type UnOp<I, O> = (a: I) => O;
type V2UnOp = UnOp<Vector2, Vector2>;

/** @see {@link Vec2.map} */
function map2x1<I, O>(op: UnOp<I, O>): (a: Pair<I>) => Pair<O> {
...
export namespace Vec2 {
  ...
  export const negate: V2UnOp = map2x1((a: number) => -a);
  export const floor: V2UnOp = map2x1(Math.floor);
  export const ceil: V2UnOp = map2x1(Math.ceil);
  export const round: V2UnOp = map2x1(Math.round);
